...
INSERT INTO "pos_log" VALUES(9,'2026-08-21 12:41:14',7,'insert','{"id":7,"symbol":"KENNAMET","cluster":"small","status":"pending","queued_on":"2026-08-21","entry_day":null,"entry_px":null,"qty":11,"stop":3640.23,"target":4853.64,"exit_day":null,"exit_px":null,"exit_reason":null,"net":null,"features":null,"fill_source":null,"bucket":"pooled","origin":null}');
INSERT INTO "pos_log" VALUES(10,'2026-08-24 06:29:34',7,'update','{"id":7,"symbol":"KENNAMET","cluster":"small","status":"open","queued_on":"2026-08-21","entry_day":"2026-08-24","entry_px":4048.0,"qty":11,"stop":3643.2,"target":4857.6,"exit_day":null,"exit_px":null,"exit_reason":null,"net":null,"features":null,"fill_source":"live:upstox","bucket":"pooled","origin":null}');
...
CREATE TRIGGER pos_log_upd AFTER UPDATE ON pos BEGIN
    ...
    END;
CREATE UNIQUE INDEX ux_pos_live ON pos(symbol, bucket) WHERE status IN ('pending','open');
COMMIT;
